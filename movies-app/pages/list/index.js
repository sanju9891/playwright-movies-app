...
const Empty = ({ listId }) => (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
    ...
    <h3 style={{ fontSize: "2rem", fontWeight: theme.typography.fontWeightLight }}>
      This list is empty.{" "}
      <Link legacyBehaviour href={{ pathname: LINKS.ADD_OR_REMOVE_ITEMS_AT_LIST.HREF, query: { [QUERY_PARAMS.LIST_ID]: listId, [QUERY_PARAMS.PAGE]: 1 } }}>Add some movies.</Link>
    </h3>
    </div>
  </div>
);
      ...
      <>
        ...
        <PageWrapper>
          <PaddingWrapper>
            ...
            {movies.total_results === 0 ? <Empty listId={listId} /> : (
              <MovieList
                movies={movies}
